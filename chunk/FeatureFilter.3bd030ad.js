...
import { v as v$1, n } from './timeSupport.63616a82.js';
import { v } from './utils.6a9cfa43.js';
import { u as u$1 } from './FeatureStore2D.1de0ba2d.js';
import './projectionSupport.a57fde16.js';
import './json.dcc9ce98.js';
import './CircularArray.976fe174.js';
...
*/
const t=s$1.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(r,s){const n=await import('./WhereClause.c61765bb.js');try{const o=n.WhereClause.create(r,s);if(!o.isStandardized){const r=new s$2("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(r);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(o){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}
...
export { y as default };
//# sourceMappingURL=FeatureFilter.3bd030ad.js.map
