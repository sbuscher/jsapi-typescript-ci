import { c7 as a$2, gz as t, r } from '../index.js';
...
See https://js.arcgis.com/4.24/esri/copyright.txt for details.
*/
function e(){return n$1||(n$1=new Promise((t=>import('./i3s.bf25cacc.js').then((t=>t.i)).then((({default:e})=>{const n=e({locateFile:i$1,onRuntimeInitialized:()=>t(n)});delete n.then;})))).catch((t=>{throw t}))),n$1}function i$1(e){return a$2(`esri/libs/i3s/${e}`)}let n$1;
...
//# sourceMappingURL=SceneLayerWorker.0b1313ac.js.map
